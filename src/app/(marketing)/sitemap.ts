...
const STATIC: {
  ...
  { path: "/for/consultants", updated: "2026-09-18", priority: 0.8, changeFrequency: "monthly" },
  { path: "/for/wholesale", updated: "2026-09-18", priority: 0.8, changeFrequency: "monthly" },
