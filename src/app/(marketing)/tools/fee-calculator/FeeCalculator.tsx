...
const fieldClass =
  "mt-1.5 w-full rounded-lg border border-rule-strong bg-sheet px-3 py-2.5 text-small text-ink focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-action";
