...
- Tokenized cards or ACH mandates
- Smart retries / dunning without burning trust
- Plan changes, proration, and pauses
- Clear invoices and failed-payment UX
- Finance-ready reporting

A merchant account that can run recurring charges is necessary but not sufficient if your catalog is complex.

## Three common architectures

1. **All-in-one billing platforms** (processor + subscription engine)  
   Fast to start; watch exit costs and entitlement limits.

2. **Merchant account + separate billing software**  
...
- Failed-payment emails and in-app prompts
...
- [CDG Commerce recurring billing guide](/cdgcommerce/recurring-billing)
- [CDG vs Stripe for growing businesses](/blog/cdg-commerce-vs-stripe-for-growing-businesses)
- Full [CDG Commerce hub](/cdgcommerce)
