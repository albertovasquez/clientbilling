...
4. If the merchant has Automatic reminders on under Getting paid, the daily cron already sends the same email at 3 and 10 days past due. Do not stack a manual remind on the same day.
5. After a week with no response, report the list to the merchant and let them decide; the agent does not escalate.
