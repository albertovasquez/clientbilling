...
7. Getting paid: payers see the merchant's payment instructions and, when the merchant has pasted a hosted payment page link, a Pay online button (decision 0014). The merchant records payments as they arrive; the full balance flips the invoice to paid, a partial payment shows a balance due on the document (decision 0019). `COLLECT_ONLINE` is unused.
